...
public class FishDrawable extends Drawable
{
    ...
    {
        //中心轴线和X轴顺时针方向夹角
        float angle = fatherAngle + (float) Math.cos(Math.toRadians(currentValue * 1.5 * waveFrequence)) * 15;
        //身长
    ...
    {
        //中心轴线和X轴顺时针方向夹角
        float angle = fatherAngle + (float) Math.sin(Math.toRadians(currentValue * 1.5 * waveFrequence)) * 35;
        //身长
